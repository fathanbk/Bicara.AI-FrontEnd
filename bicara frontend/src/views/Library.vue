          ...
          <ion-card class="history-video">
            <ion-grid>
              ...
              <ion-row class="table-history">
                <ion-col size="3">
                  <a href="">
                    <ion-img class="sample-img" src="assets/img/gambar.png"></ion-img>
                  </a>
                </ion-col>
                <ion-col>
                  <p class="tablecontent">Ambassador Kim's Remarks on Women in Fintech</p>
                </ion-col>
              </ion-row>
            </ion-grid>
          </ion-card>
...
<script lang="ts">
import { IonButton, IonContent, IonPage, IonHeader, IonToolbar, IonModal, IonPopover } from "@ionic/vue";
